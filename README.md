...
The schema stores currencies as three-letter ISO-style codes. The web and Android apps expose `USD`, `ETB`, `EUR`, `ERN`, `SSP`, `SDG`, and `LYD` across orders, transfers, journals, withdrawals, ledgers, reports, actor settings, and owner workspace creation.
